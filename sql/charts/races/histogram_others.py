...
fig = sns.distplot(a=df[df['party']=='Democrat']["others"],
                   hist=True, bins=25, kde=False, color="blue",
                   label='Democrats')
fig = sns.distplot(a=df[df['party']=='Republican']["others"],
...
fig.legend()
fig.set(title='');
fig.set(ylabel='Counties', xlabel='Asian + American Indian + Hawaiian + Latin people')
plt.show()
